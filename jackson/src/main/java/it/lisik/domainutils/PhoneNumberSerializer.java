...
public class PhoneNumberSerializer extends JsonSerializer<PhoneNumber> {
    public void serialize(PhoneNumber phoneNumber, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException, JsonProcessingException {
        jsonGenerator.writeString(phoneNumber.getValue());
    }

    @Override
    public Class<PhoneNumber> handledType() {
